...
string const map_path(/*"map.txt");*/"txts/map/map.txt");
ofstream map_of;
fstream map_f;
string const inv1_path("txts/player/items1.txt");
ofstream inv1_of;
fstream inv1_f;
string const inv2_path("txts/player/items2.txt");
ofstream inv2_of;
fstream inv2_f;
string const stats_path("txts/player/stats.txt");
fstream stats_f;
ofstream stats_of;
string const settings_path("txts/data/settings.txt");
fstream settings_f;
ofstream settings_of;
string const itemsData_path("txts/data/items.txt");
fstream itemsData_f;
ofstream itemsData_of;
string const enemiesData_path("txts/data/enemies.txt");
